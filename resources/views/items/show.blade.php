...
<div class="max-w-5xl mx-auto px-6 py-10">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div class="space-y-8">
            ...
            <a href="#" class="block w-full text-center bg-[#ed6163] hover:bg-red-500 text-white font-bold py-4 rounded transition">
                購入手続きへ
            </a>
            ...
            <div>
                ...
                <div class="flex items-center mb-4">
                    <span class="w-32 font-bold text-gray-900">カテゴリー</span>
                    <div class="flex gap-2 flex-wrap">
                        @foreach($item->categories as $category)
                            <span class="bg-gray-200 text-gray-700 px-4 py-1 rounded-full text-sm">{{ $category->name }}</span>
                        @endforeach
                    </div>
                </div>
                <div class="flex items-center">
                    <span class="w-32 min-w-max font-bold text-gray-900">商品の状態</span>
                    <span class="text-gray-700">{{ $item->condition->name }}</span>
                </div>
            </div>
